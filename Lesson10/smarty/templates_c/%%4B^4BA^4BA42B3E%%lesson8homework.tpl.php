<?php /* Smarty version 2.6.28, created on 2015-02-25 06:16:28
         compiled from lesson8homework.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'lesson8homework.tpl', 11, false),array('function', 'html_options', 'lesson8homework.tpl', 38, false),array('modifier', 'strip', 'lesson8homework.tpl', 17, false),)), $this); ?>
<HTML>
   <HEAD>
...
<form  method="post">
    ...
    <div style="margin-left:60px;margin-top:10px"> 
        ...
        <input style="margin-left:90px; width:230px" type="text" maxlength="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['showform_params']['namereturn'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)); ?>
" name="seller_name">
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
...
" name="phone">
    ...
    <div style="margin-left:60px;  margin-top:10px">
        ...
        <input style="margin-left:12px; width:230px;" type="text" maxlength="30" placeholder="<?php echo $this->_tpl_vars['showform_params']['notice_title_is_empty']; ?>
...
" name="title">
    ...
    <div style="margin-left:60px;  margin-top:10px"> 
        ...
        <textarea style="margin-left:162px; width:230px;height:70px;" maxlength="500" name="description" ><?php echo ((is_array($_tmp=$this->_tpl_vars['showform_params']['returndescription'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)); ?>
</textarea>
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
        <label >Цена</label>
...
" name="price" >                                                         
    ...
    <div style="margin-left:221px;  margin-top:10px "> 
        <input style="height: 30px" type="hidden" value="<?php echo $this->_tpl_vars['showform_params']['return_id']; ?>
" name="return_id" >
  ...
  <table method="post" style="border: 1px solid black; margin-top:30px;margin-left: 80px">
        <div >
         ...
         <div style="margin-left:111px;  margin-top:10px"> 
            <?php echo $this->_tpl_vars['showform_params']['notice_edit_success']; ?>
