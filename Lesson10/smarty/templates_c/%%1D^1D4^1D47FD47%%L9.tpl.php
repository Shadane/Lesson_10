<?php /* Smarty version 2.6.28, created on 2015-03-06 14:39:33
         compiled from L9.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'L9.tpl', 11, false),array('function', 'html_options', 'L9.tpl', 25, false),array('modifier', 'strip', 'L9.tpl', 17, false),array('modifier', 'escape', 'L9.tpl', 17, false),)), $this); ?>
<HTML>
   <HEAD>
...
<form method="post">
    ...
    <div style="margin-left:60px;margin-top:10px"> 
        ...
        <input style="margin-left:90px; width:230px" type="text" maxlength="20" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['namereturn'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
" name="seller_name">
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
        <label>Электронная почта</label>
        <input style="margin-left:27px; width:230px;" type="text" maxlength="50" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['email_return'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
" name="email">
        <div>
            <select style="margin-left:242px; width:150px;height:15px;margin-top:-5px" title="список авторов" name="saved_email"> 
                 <option value="0"></option>
                  <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['emails'],'selected' => $this->_tpl_vars['showform_params']['emails']), $this);?>
 ...
 value="1" name="allow_mails">
    ...
    <div style="margin-left:60px;  margin-top:10px"> 
        ...
        <input style="margin-left:46px; width:230px" type="text"  value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['phonereturn'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
" name="phone">
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
       <label >Город</label> 
    ...
    <div style="margin-left:60px;  margin-top:10px">
        ...
        <input style="margin-left:12px; width:230px;" type="text" maxlength="30" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['returntitle'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
" name="title">
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
        <label style="position:absolute">Описание объявления</label>
        <textarea style="margin-left:162px; width:230px;height:70px;" maxlength="500" name="description" ><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['returndescription'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
</textarea>
    </div>
    <div style="margin-left:60px;  margin-top:10px"> 
        <label >Цена</label>
        <input style="margin-left:124px; width:230px" type="text" maxlength="9"  value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['showform_params']['returnprice'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'utf-8') : smarty_modifier_escape($_tmp, 'htmlall', 'utf-8')); ?>
" name="price" >                                                         
    </div>
